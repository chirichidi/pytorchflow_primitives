...
def parse_train_args():
    ...
    parser.add_argument("--model", type=str, default="mlp", choices=["mlp", "lenet", "lenet_inj", "lenet_multiconv", "lenet_incep"], help="model name")
...
def parse_infer_args():
    ...
    parser.add_argument("--data", type=str, default="mnist", choices=["mnist", "cifar10"], help="dataset name")
    parser.add_argument("--model", type=str, default="mlp", choices=["mlp", "lenet", "lenet_inj", "lenet_multiconv", "lenet_incep"])
    return parser.parse_args()