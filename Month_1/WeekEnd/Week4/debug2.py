...
class myMLP(nn.Module):
    def __init__(self, image_size, hidden_size, num_class):
        ...
        self.mlp3 = nn.Linear(in_features=hidden_size, out_features=num_class)
        self.mlp4 = nn.Linear(in_features=hidden_size, out_features=hidden_size)
...
model = myMLP(image_size=image_size, hidden_size=hidden_size, num_class=num_class).to(
    device
)
